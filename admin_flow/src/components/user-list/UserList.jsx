...
const rows = [
  ...
  createData('Isha Syed', 'Alumni', 'dokoshish42@gmail.com'),
      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table" className="table">
        <TableHead>
          <TableRow>
            ...
            <TableCell align="center" className="heading">Options</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.map((row) => (
            ...
            >
              ...
              <TableCell align="center" className="content"><Button href="single" className="viewbut">View</Button></TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
