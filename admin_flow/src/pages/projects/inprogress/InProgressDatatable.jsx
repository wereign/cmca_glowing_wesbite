...
const rows = [
  ...
  // createData('Juhu Cleanliness Drive', "1", "24th July, 2022", "5th July, 2022"),
  // createData('Pipeline fixing', "1", "23rd July, 2022", "25th July, 2022"),
  ...
  // createData('Help Society', "1", "2nd July, 2022", "11th July, 2022"),
  // createData('Be Nice To Everyone', "1", "18th June, 2022", "19th June, 2022"),
  createData('CMCA is Doing Good', "0", "5th June, 2022", "23rd June, 2022")
];

const InProgressDatatable = () => {
  return (
        ...
        <TableBody>
          {rows.map((row) => (
            ...
            >
              ...
              {/* <TableCell align="right"><span className="incomplete"><FiberManualRecordIcon /></span></TableCell> */}
              <TableCell align="right">{displayAddLog(row.status)}</TableCell>
...
function displayAddLog(complete) {
  ...
  if (complete==="1") {
      return <span className="complete"><FiberManualRecordIcon /></span>
  }
  
  else{
    return <span className="incomplete"><FiberManualRecordIcon /></span>
  }

}

export default InProgressDatatable